...
function merge(observable1: Observable, observable2: Observable): Observable {
...
function combineLatest(observable1: Observable, observable2: Observable): Observable {
